...
const ForgotPassword: React.FC<ForgotPasswordProps> = ({ show, onClose }) => {
  ...
  return (
    <div className={`fixed inset-0 flex items-center justify-center z-50 ${show ? "" : "hidden"}`}>
      <div className="relative w-3/4 md:w-5/12 lg:w-4/12 h-auto py-10 rounded-lg bg-white border border-text flex items-center justify-center">
      <div className="flex flex-col justify-center items-center px-9 md:px-12 lg:px-16">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center text-gray-800">
              ...
              <input
                ...
                className="text-gray-800 text-sm mb-2 mt-3 px-5 p-2 rounded-md border border-gray-500 w-full"
                required
              />
              <button
