...
const Login: React.FC<LoginProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      <div className="bg-white relative w-11/12 sm:w-3/4 md:w-7/12 lg:w-4/12 h-auto py-10 rounded-lg bg-background border border-text flex items-center justify-center">
            ...
            <div className="flex flex-col justify-center items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex justify-end">
                    <a
                      ...
                      className="text-[#2c58c9] text-sm right-1 hover:cursor-pointer mb-1"
                    >
                      forgot password
                    </a>
                  </div>
              ...
              <p className="text-sm text-text">
                ...
                <a
                  ...
                  className="text-[#2c58c9] underline cursor-pointer"
                >
                  Sign Up
                </a>
              </p>
